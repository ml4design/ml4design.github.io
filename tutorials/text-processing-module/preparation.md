...
Download the document named “*task_2.txt*” by clicking <a href="{{site.baseurl}}/assets/task_2.txt" download="task_2.txt">here</a>.
...
5. Open the *task_2.txt*, read several texts 
